...
class _newsState extends State<news> {
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: Image.asset(Imagesinbox(index),fit: BoxFit.fill,),
                                  ),
                                  SizedBox(width: 10,),
                                  Column(
                                    children: [
                                          ...
                                          child: Container(
                                            ...
                                            child: Align(
                                              alignment: Alignment.bottomLeft,
                                                child: Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do",
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      child: Row(
                                                        children: [
                                                          Icon(Icons.history,color: Colors.green,size: 13,),
                                                          SizedBox(width: 4,),
                                                          Text("Updated ${index} days ago",style: TextStyle(fontSize: 12),),
                                                        ],
                                                      ),
                                                    ),
                                                    Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Center(child: Text("Read Now",style: TextStyle(color:Colors.white,fontSize: 12),)),
                                                      ),
                                                    ),
                                                  ],
                                                )),
  ...
  String Imagesinbox(int index) {
    if (index%4==0){
      return "assets/images/Rectangle1.png";
    }
    if (index%4==1){
