...
class _fundbodyState extends State<fundbody> with SingleTickerProviderStateMixin{
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.search,size: 25,color: Color(0xFF1EC78F),),
                        filled: true,
                  ...
                  Container(
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        Tab(
                          child: Text("Mutual Funds",style: TextStyle(color: Colors.green,fontSize: 18),),
                        ),
                        Tab(
                          child: Text("Small Cases",style: TextStyle(color: Colors.green,fontSize: 18),),
                        ),
